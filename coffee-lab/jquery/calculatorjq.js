...
$(document).ready(function() {
    ...
    function initCalculatorBacsis() {
        ...
        function calculeazaBacsis() {
            ...
            if (procent === 10) {
                $mesajDiv.html('Mulțumim! Gestul tau este apreciat!').removeClass('succes alert');
            } else if (procent === 15) {
                $mesajDiv.html('Generos! Multumim pentru sprijin!').addClass('succes').removeClass('alert');
            } else if (procent === 20) {
                $mesajDiv.html('WOW! Ești un client de aur!').addClass('succes').removeClass('alert');
            } else {
                $mesajDiv.html('').removeClass('succes alert');
            }
        }
